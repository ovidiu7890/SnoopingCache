...
HD_PWD='C:/facultate/3sem1/ssc/proiect/linked_list/linked_list.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log datastructures.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source datastructures.tcl
