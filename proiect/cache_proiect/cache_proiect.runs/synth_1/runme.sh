...
HD_PWD='C:/facultate/3sem1/ssc/SnoopingCache/proiect/cache_proiect/cache_proiect.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_m.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_m.tcl
