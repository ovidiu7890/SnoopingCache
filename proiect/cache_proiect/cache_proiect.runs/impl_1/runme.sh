...
HD_PWD='C:/facultate/3sem1/ssc/SnoopingCache/proiect/cache_proiect/cache_proiect.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_m.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_m.tcl -notrace
